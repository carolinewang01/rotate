...
def log_heldout_metrics(config, logger, eval_metrics, 
    ...
    for metric_name in metric_names:
        ...
        # shape of eval_metrics[metric_name] is (num_iter/num_seeds, num_heldout_agents, num_eval_episodes, 2)
        ...
        # TODO: figure out how to handle seeds vs iters
        # TODO: how do we handle the case where we have both seeds and iters?
