...
if __name__ == "__main__":
    ...
    for task_name in task_list:
        all_task_results[task_name] = load_results_for_task(task_name, RESULTS_TO_PLOT, 
                                                            HELDOUT_CURVES_CACHE_FILENAME, load_from_cache=True)
        ...
        PLOT_ARGS = {
            ...
            "savename": f"{PLOT_TYPE}_curves_{task_name.replace('/', '_')}",
