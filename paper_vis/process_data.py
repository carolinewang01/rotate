...
from paper_vis.plot_globals import TASK_TO_ENV_NAME, CACHE_FILENAME, GLOBAL_HELDOUT_CONFIG


def load_results_for_task(task_name, method_dict, load_from_cache: bool = True):
